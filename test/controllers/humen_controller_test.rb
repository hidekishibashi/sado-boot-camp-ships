...
class HumenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create human" do
    assert_difference('Human.count') do
      post humen_url, params: { human: { age: @human.age, height: @human.height, name: @human.name, weight: @human.weight } }
    end
  ...
  test "should update human" do
    patch human_url(@human), params: { human: { age: @human.age, height: @human.height, name: @human.name, weight: @human.weight } }
